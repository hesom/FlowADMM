...
run_case ot ot_ode gaussian_deblurring_FFT steps_ode 100 start_time 0.4 gamma gamma_t
...
run_case ot pnp_flow gaussian_deblurring_FFT steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 1 alpha 0.01
run_case ot pnp_flow superresolution steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 1 alpha 0.3
run_case ot pnp_flow inpainting steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 1 alpha 0.5
run_case ot pnp_flow random_inpainting steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 1 alpha 0.01

# PnP-Flow5
run_case ot pnp_flow denoising steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 5 alpha 0.8
run_case ot pnp_flow gaussian_deblurring_FFT steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 5 alpha 0.01
run_case ot pnp_flow superresolution steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 5 alpha 0.3
run_case ot pnp_flow inpainting steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 5 alpha 0.5
run_case ot pnp_flow random_inpainting steps_pnp 100 lr_pnp 1.0 gamma_style alpha_1_minus_t num_samples 5 alpha 0.01

# Flower1-OT
run_case ot flower denoising steps 100 num_samples 1
run_case ot flower gaussian_deblurring_FFT steps 100 num_samples 1
run_case ot flower superresolution steps 100 num_samples 1
run_case ot flower inpainting steps 100 num_samples 1
run_case ot flower random_inpainting steps 100 num_samples 1

# Flower5-OT
run_case ot flower denoising steps 100 num_samples 5
run_case ot flower gaussian_deblurring_FFT steps 100 num_samples 5
run_case ot flower superresolution steps 100 num_samples 5
run_case ot flower inpainting steps 100 num_samples 5
run_case ot flower random_inpainting steps 100 num_samples 5
